...
public class admin_add_oil extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int j=model.add_product_into_final_product_list(a,b,c,d,e,is);
		int i=model.add_admin_product(a,b,c,d,e,js);
		
		if(i!=0 && j!=0)
		{
			RequestDispatcher rd=request.getRequestDispatcher("add_Product_admin.jsp");
//			RequestDispatcher rx=request.getRequestDispatcher("add_Product_admin.jsp");
