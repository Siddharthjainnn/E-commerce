...
@WebServlet("/get_update_daily")
public class get_update_daily extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String a=(String)request.getParameter("user_id");
		admin_model model=new admin_model();
	Product pp=	model.get_full_daily_admin(a);
	if(pp!=null)
	{
		RequestDispatcher rd=request.getRequestDispatcher("update_page_product_10.jsp");
