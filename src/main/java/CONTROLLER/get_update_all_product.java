...
@WebServlet("/get_update_all_product")
public class get_update_all_product extends HttpServlet {
	...
	if(pp!=null)
	{
		RequestDispatcher rd=request.getRequestDispatcher("update_page_all_product.jsp");
