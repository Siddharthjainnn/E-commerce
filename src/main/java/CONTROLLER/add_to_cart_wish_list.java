...
@WebServlet("/add_to_cart_wish_list")
public class add_to_cart_wish_list extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	   ...
	   ArrayList<Product> list= model.add_to_cart_wishlist(a);
	   if(list!=null)
		{
			RequestDispatcher rd=request.getRequestDispatcher("confirm_cart_wishlist.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Product> list = model.get_wish_list(jk);
		if (i != 0) {
			RequestDispatcher rd = request.getRequestDispatcher("wish_list_page.jsp");
