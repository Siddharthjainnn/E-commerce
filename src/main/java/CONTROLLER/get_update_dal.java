...
@WebServlet("/get_update_dal")
public class get_update_dal extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String a=(String)request.getParameter("user_id");
		admin_model model=new admin_model();
	Product pp=	model.get_full_dal_admin(a);
	if(pp!=null)
	{
		RequestDispatcher rd=request.getRequestDispatcher("update_page_product_5.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(i!=0)
		{
			RequestDispatcher rd=request.getRequestDispatcher("daladmin.jsp");
