...
@WebServlet("/add_to_cart_4")
public class add_to_cart_4 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String a=(String)request.getParameter("pro_id");
		admin_model model=new admin_model();
	   ArrayList<Product> list= model.add_to_cart_4(a);
	   if(list!=null)
		{
			RequestDispatcher rd=request.getRequestDispatcher("confirm_cart_4.jsp");
