...
@WebServlet("/get_update_soap")
public class get_update_soap extends HttpServlet {
	...
	Product pp=	model.get_full_soap_admin(a);
	if(pp!=null)
	{
		RequestDispatcher rd=request.getRequestDispatcher("update_page_product_2.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(i!=0)
		{
			RequestDispatcher rd=request.getRequestDispatcher("soap&detergentadmin.jsp");
