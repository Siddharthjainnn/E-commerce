...
@WebServlet("/get_update_oil")
public class get_update_oil extends HttpServlet {
	...
	Product pp=	model.get_full_oil_admin(a);
	if(pp!=null)
	{
		RequestDispatcher rd=request.getRequestDispatcher("update_page_product.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(i!=0)
		{
			RequestDispatcher rd=request.getRequestDispatcher("oil&gheeadmin.jsp");
