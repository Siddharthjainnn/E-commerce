...
@WebServlet("/admin_add_product_12")
public class admin_add_product_12 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(i!=0)
		{
			RequestDispatcher rd=request.getRequestDispatcher("add_Product_admin_12.jsp");
			RequestDispatcher rx=request.getRequestDispatcher("add_Product_admin_12.jsp");
