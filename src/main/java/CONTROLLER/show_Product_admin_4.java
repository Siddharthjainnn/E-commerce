...
@WebServlet("/show_Product_admin_4")
public class show_Product_admin_4 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(list!=null)
		{
			RequestDispatcher rd=request.getRequestDispatcher("spices&masalaadmin.jsp");
