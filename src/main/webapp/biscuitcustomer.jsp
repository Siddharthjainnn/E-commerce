...
<%-- <%if(aa!=null)
	{%>
		...
		<div class="product-page">
			<h2 class="product-he">
				Our <span class="product-sp"> Biscuit Products</span>
			</h2>
			<br>
			<hr style="width: 29cm">
			<div class="container">
				<div class="row">
					...
					<div class="col-4">
						<div class="categori-pro" style="height: 600px;width: 100px;">
							...
							<form action="like_category_8" method="post">
    ...
    <script>
        document.getElementById("heartIcon").addEventListener("click", function() {
            this.classList.toggle("clicked");
								...
								<img src="./get_image_admin_biscuit?pro_id=<%=mm.getPro_id()%>"
							...
							<a href="./add_to_cart_9?pro_id=<%=mm.getPro_id()%>"><input type="button"
						...
						<div class="card-body pt-5">
							...
							<div >
								<%-- <a href="./add_to_cart_7?pro_id=<%=mm.getPro_id()%>"><input
									...
									<a href="./add_to_cart_9?pro_id=<%=mm.getPro_id()%>"><label class="btn btn-success form-check-label active" style="width: 5cm;"> <input
