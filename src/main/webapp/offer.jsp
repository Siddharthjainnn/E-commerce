...
<body>
	...
	<%
	ArrayList<product_new> list = (ArrayList<product_new>) request.getAttribute("list");
	%>
		...
		{%>
					...
					<div class="col-4">
						<div class="categori-pro" style="height: 600px;width: 100px;">
							...
							<form action="like_category_12" method="post">
    ...
    <script>
        document.getElementById("heartIcon").addEventListener("click", function() {
            this.classList.toggle("clicked");
								...
								<img src="./get_image_admin_agarbati?pro_id=<%=mm.getPro_id()%>"
								...
								<a href="./add_to_cart_11?pro_id=<%=mm.getPro_id()%>"><input type="button"
		...
		<div class="product-page">
			<h2 class="product-he">
				Our <span class="product-sp"> Agarbatii & pujja</span>
			</h2>
			<br>
			<hr style="width: 29cm">
			<div class="container">
...
<%
		...
		<div id="products">
			<div class="row mx-0">
				<%
				for (product_new mm : list) {
				%>
				<div class="col-lg-4 col-md-6" style="margin-bottom: 1cm;">

<div class="offer-badge" style="background-color: yellow; position: absolute; top: 0; left: 0; padding: 5px 10px; color: black; font-weight: bold;z-index: 1;">
        OFFER
    </div>
					...
					<div class="card d-flex flex-column align-items-center">
						...
						<div class="text text-center mt-auto ok1" style="font-size: 0.4cm;font-weight: 1000;color: green;"">Offer Starting Date : <%=mm.getStr_date() %>
								
								</div>
								<div class="text text-center mt-auto ok2" style="font-size: 0.4cm;font-weight: 1000;color: red;">Offer End Date : <%=mm.getEnd_date() %>
						...
						<div class="card-body pt-5">
							...
							<div class="d-flex align-items-center price" style="margin-left: 1.5cm;">
								<div class="del mr-2">
									<span class="text-dark" style="font-size: 0.4cm;"><%=mm.getPrice() %></span>
								</div>
								<div class="font-weight-bold"style="font-size: 0.6cm;"><%=mm.getOffer_price() %></div>
							</div>
							...
							<div >
								<%-- <a href="./add_to_cart_7?pro_id=<%=mm.getPro_id()%>"><input
									...
									<a href="./add_to_cart_11?pro_id=<%=mm.getPro_id()%>"><label class="btn btn-success form-check-label active" style="width: 5cm;"> <input
