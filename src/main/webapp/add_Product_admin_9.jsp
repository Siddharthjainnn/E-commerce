...
<div class="jumbotron jumbotron-fluid">
  ...
  <form  action="admin_add_product_9" method="post" enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter password" name="category" value="AGARBATTI & POJJA ITEMS" readonly>
  </div>
  <div class="form-group">
