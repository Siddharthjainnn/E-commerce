...
<div class="formbold-main-wrapper">
  ...
  <div class="formbold-form-wrapper">
    <form action="new_feature_photo_uplod" enctype="multipart/form-data" method="post">
        ...
        <div class="formbold-form-step-1 active">
          ...
          <div class="formbold-input-flex">
              <div>
                  <label for="dob" class="formbold-form-label">Order Id</label>
               <%--    <% 
    ...
    %>
     ...
     <%final String randomCode = UUID.randomUUID().toString();
		...
		final String randomCode2 = UUID.randomUUID().toString().substring(0, 5); %>
          ...
          <div class="formbold-input-flex">
              <div>
                  <label for="dob" class="formbold-form-label">Order Date </label>
                  <% 
        // Import the necessary Java classes
        java.util.Date currentDate = new java.util.Date();
    ...
    %>
          ...
          <br>
          <div>
              <label for="address" class="formbold-form-label"> Send The Photo Of List </label>
              <input
              type="file"
              name="image"
              id="address"
        ...
        <div class="formbold-form-step-2">
          <div>
            <label for="message" class="formbold-form-label"> Delivery Instructions </label>
            <textarea
              rows="6"
              name="message"
              id="message"
