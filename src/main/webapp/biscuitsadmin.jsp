...
<%} %> 
	...
	<thead class="thead-dark">
		...
		<tr>
			...
			<td><%=mm.getPrice()%></td>
			<td><img alt="image not found" src="./get_image_admin_biscuit?pro_id=<%=mm.getPro_id()%>"  height="200px" ,width="200px"></td>
	...
	<td><a href="./get_delete_biscuit?user_id=<%=mm.getPro_id()%>" class="btn btn-danger" onclick=" return alert('are you sure you whant to delete')">DELETE</a></td>
		    <td><a href="./get_update_buscuit?user_id=<%=mm.getPro_id()%>" class="btn btn-primary">UPDATE</a></td>
	</tr>
		<%
		}
		%>
