...
<br>
              ...
              <%for(order_by_image_user_2 kl:list){ %>
                 ...
                 <td><%=kl.getUser_id() %></td>
                 <td><%=kl.getName() %></td>
                 <td><%=kl.getEmail_id() %></td>
                 
                 <td><a href="view_order_for_customer_on_order_id_and_customer_id_order_id_by_image_FOR_ADMIN?order_id=<%=kl.getOrder_id() %>&user_id=<%=kl.getUser_id() %>" class="btn btn-primary">view order</a></td>
                 </tr>
