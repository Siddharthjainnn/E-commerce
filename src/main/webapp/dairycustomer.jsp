...
<body>
	...
	<section class="product-section" id="product-section">
		...
		<div class="product-page">
			<h2 class="product-he">
				Our <span class="product-sp"> Dairy Products</span>
			</h2>
			<br>
			<hr style="width: 29cm">
			<div class="container">
					...
					<div class="col-4">
						<div class="categori-pro" style="height: 600px; width: 100px;">
							<div class="box3">
								...
								<form action="like_category_9" method="post">
									...
									<div class="heart" id="heartIcon">
										<button type="submit"
											...
											<i class="fas fa-heart fa-xl"
												style="margin-left: 220px; color: red;"></i></a>
									</div>
								</form>
								<script>
									document
								...
								<img src="./get_image_admin_dairy?pro_id=<%=mm.getPro_id()%>"
									class="categ-img" alt=""
									style="height: 270px; width: 270px; padding: 20px;">
								<div>
									<h3 class="categ-he">
										<span style="color: red;">PRO ID : <%=mm.getPro_id()%></span>
									</h3>
									<h1>
										<span style="color: black;"><%=mm.getName()%></span>
									</h1>
									<h5>
										<span style="color: olive;"><%=mm.getCategory()%></span>
									</h5>
									<h3>
										<span style="color: red;">RS.<%=mm.getPrice()%>/-
										</span>
									</h3>
								</div>
					...
					<div class="card d-flex flex-column align-items-center">
						...
						<div class="card-body pt-5">
							...
							<div >
								<%-- <a href="./add_to_cart_7?pro_id=<%=mm.getPro_id()%>"><input
									type="button" value="Add To Cart" class="categ-btn"></a> --%>
									<a href="./add_to_cart_7?pro_id=<%=mm.getPro_id()%>"><label class="btn btn-success form-check-label active" style="width: 5cm;"> <input
