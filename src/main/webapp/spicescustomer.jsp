				...
				<div class="row">
					...
					<div class="col-4">
						<div class="categori-pro" style="height: 600px;width: 100px;">
							<div class="box3">
							<form action="like_category_3" method="post">
						...
						<div class="card-body pt-5">
							...
							<div >
								<%-- <a href="./add_to_cart_7?pro_id=<%=mm.getPro_id()%>"><input
									...
									<a href="./add_to_cart_3?pro_id=<%=mm.getPro_id()%>"><label class="btn btn-success form-check-label active" style="width: 5cm;"> <input
