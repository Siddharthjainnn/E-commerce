...
<%new_customer_add okk=(new_customer_add)request.getAttribute("msg"); %>
<div class="jumbotron jumbotron-fluid">
  <div class="container">
  
  <form  action="get_update_customer" method="post" enctype="multipart/form-data">
								...
								<div class="row">
									<div class="col-lg-6">
										<div class="mb-3">
											...
											<input
												type="text" class="form-control" name="name" value="<%=okk.getName()%>">
										</div>
									</div>
									<div class="col-lg-6">
										<div class="mb-3">
											<label class="form-label">User Id</label> <input type="text"
												class="form-control" name="user_id" value="<%=okk.getUser_id()%>">
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-lg-6">
										<div class="mb-3">
											<label class="form-label">Email</label> <input type="email"
												class="form-control" name="email_id" value="<%=okk.getEmail_id()%>">
										</div>
									</div>
									<div class="col-lg-6">
										<div class="mb-3">
											<label class="form-label">Phone number</label> <input
												type="text" class="form-control" name="phone" value="<%=okk.getPhone()%>">
										</div>
									</div>
									...
									<div class="col-lg-6">
										<div class="mb-3">
											<label class="form-label">Set Password</label> <input type="text"
												class="form-control" name="password" value="<%=okk.getPassword()%>">
										</div>
									</div>
									<div class="col-lg-6">
										<div class="mb-3">
							...
							<div class="card-body">
								...
								<div class="mb-3">
									<label class="form-label">Address Line 1</label> <input
										type="text" class="form-control" name="adress" value="<%=okk.getAdress()%>">
								</div>
									...
									<div class="col-lg-6">
										<div class="mb-3">
											<label class="form-label">ZIP code</label> <input type="text"
												class="form-control" name="zip" value="<%=okk.getZip()%>">
										</div>
									</div>
								</div>
								<div class="row">
									...
									<div class="col-lg-6">
										<div class="mb-3">
											<label class="form-label"></label>Occupation <input type="text"
												class="form-control" name="occupation" value="<%=okk.getOccupation()%>">
										</div>
									</div>
								</div>
							</div>
					...
					<div class="col-lg-4">
						...
						<div class="card mb-4">
							<div class="card-body">
								...
								<input type="date" name="dob" value="<%=okk.getDob()%>">
							</div>
						</div>
						<!-- Avatar -->
						<div class="card mb-4">
						...
						<div class="card mb-4">
							<div class="card-body">
								...
								<textarea class="form-control" rows="3" name="notes" value="<%=okk.getNotes()%>"></textarea>
							</div>
						</div>
