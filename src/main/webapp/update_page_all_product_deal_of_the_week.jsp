...
<div class="jumbotron jumbotron-fluid">
  ...
  <form  action="get_update_all_product_4" method="post" enctype="multipart/form-data">
  ...
  <button type="submit" class="btn btn-primary">ADD PRODUCT TO DEAL OF WEEK</button>
